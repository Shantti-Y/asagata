...
const getWeatherReport = new Promise((resolve, reject) => {
   fs.readFile('./public/src/jsons/open_weather_map/cities_in_japan.json', 'utf-8', (err, data) => {
      let parsed_data = JSON.parse(data)
      let searched_data = iDSearch(parsed_data, 'Shiga-ken')
